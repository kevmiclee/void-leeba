...
export const hypnoScenes = {
  ...
  "hypno-practice": (payload?: ScenePayload): Scene => ({
    id: "hypno-practice",
    background: bgDefault,
    text:
  ...
  "hypno-practice1": (payload?: ScenePayload): Scene => ({
    id: "hypno-practice1",
    background: bgDefault,
  ...
  hypno1: (payload?: ScenePayload): Scene => ({
    id: "hypno1",
    background: bgDefault,
    text:
  ...
  hypno2: (payload?: ScenePayload): Scene => ({
    id: "hypno2",
    background: bgDefault,
    text: ``,
  ...
  hypno3: (payload?: ScenePayload): Scene => ({
    id: "hypno3",
    background: bgDefault,
    text:
  ...
  hypno4: (payload?: ScenePayload): Scene => ({
    id: "hypno4",
    background: bgDefault,
    text:
  ...
  hypno5: (payload?: ScenePayload): Scene => ({
    id: "hypno5",
    background: bgDefault,
    text:
  ...
  hypno6: (payload?: ScenePayload): Scene => ({
    id: "hypno6",
    background: bgDefault,
    text:
  ...
  "hypno-ready-check": (payload?: ScenePayload): Scene => ({
    id: "hypno-ready-check",
    background: bgDefault,
    text: ``,
    dialogSequence: () => [
      {
  ...
  "hypno-ready": (payload?: ScenePayload): Scene => ({
    id: "hypno-ready",
    background: bgDefault,
    text: ``,
    dialogSequence: () => [
  ...
  "hypno-ready1": (payload?: ScenePayload): Scene => ({
    id: "hypno-ready1",
    background: bgDefault,
    text:
